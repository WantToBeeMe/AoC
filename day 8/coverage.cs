...
class coverage
{
    public static int getCoverage(string[] args, bool prints = false)
    {
        ...
        if(prints) Console.WriteLine($"input day 8: {height} x {length} \n");
        ...
        if(prints)Console.WriteLine($"total of tree coverage is  {SeenCount}");
        return SeenCount;
    }
}
